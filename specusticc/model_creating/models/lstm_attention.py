...
class LSTMAttention:
    ...
    def build_model(self,
        ...
        encoder_in = L.Input(shape=(self.context_timesteps, self.context_features), name='Encoder_input')
        ...
        decoder_in = L.Input(shape=(self.input_timesteps, self.input_features), name='Decoder_input')
