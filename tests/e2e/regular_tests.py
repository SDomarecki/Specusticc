...
#
# def test_runApplicationForBasic_sampleConfig_returnsCSVReport():
#     model_names = ["basic"]
...
#     assert {"basic_1.csv", "basic_2.csv", "true_data.csv"}.issubset(
#         set(test_0_files)
#     ) and {"basic_1.csv", "basic_2.csv", "true_data.csv"}.issubset(set(train_files))
#
#
