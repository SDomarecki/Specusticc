...
class OutputAnalyzer:
    ...
    def load_all_results(self):
        ...
        for dir in dirs:
            ...
            if nr == '1':
                ...
                pred_test_name_groupped[name] = pred_test_name_groupped[name].merge(pred_test, left_on='date', right_on='date', how='outer')
    ...
    def draw_summary_plot(self):
        ...
        sp = SummaryPlotter(plotter_train_data, plotter_test_data)
        sp.draw_plots()